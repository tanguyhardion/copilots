...
from copilots_app.services.word.dsl.edit_parser import parse_edit_dsl, looks_like_edit_dsl
...
from copilots_app.services.word.gui.highlighter import DSLHighlighter
